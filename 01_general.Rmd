...
The movies would like you to believe that science is just a series of eureka moments had by oddball geniuses who can't seem to do anything right most of the time, but will intuit the perfect solution to any problem with just a moment's reflection.  As anyone who's actually engaged in scientific research knows, this is a bunch of BS.  On the contrary, if you're doing good science it's going to take a lot of hard work.  However, a few simple steps can be taken, but which will avoid a lot of wasted time.  There are a few things you can control in your research efforts, and being organized is one of them, so do it.
...
I'm not saying you have to go as far as Richard Stallman (the guy pictured).  But you have already long used and benefited from open source software, so all I'm saying is continue doing so in your own research. 
...
The following provides an example where the final model is a mixed model with random intercepts 
...
However, your computer may not have enough hardware to do sophisticated analysis with the data you are interested in, and so you may have have to work on other machines.  While this is getting much easier, you may have to gain some technical know-how to use, for example, a computing cluster environment of some kind.  At some point everything will be cloud-based, and applied researchers can remain completely ignorant of basic aspects of computing, but we're not quite there yet.
...
The time will come when you'll need to move beyond the basic stats you were formally taught, and you'll have to teach yourself and/or get some help to learn these new techniques, or they will remain magic to you.  However, learning new things is part of the definition of being an academic (and human for that matter).  You don't necessarily have to be an expert, but saying something is statistically significant is not enough to demonstrate knowledge of a technique.  Be prepared to do some work.
