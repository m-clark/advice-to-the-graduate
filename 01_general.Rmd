...
In addition, when displaying information, think multivariately.  2d plots such as simple bar and scatterplots are a waste of time, and it's simply too easy to add more information.  For example, with a scatterplot one can use size to represent another variable, color for some grouping, and transparency for yet another variable.  You now have 5 pieces of information represented in the same graph.
...
Your theory, whatever you're researching, resides somewhere between false to mostly correct. Regardless, it is incomplete, and possibly grossly inaccurate in places, but without the progress of science we'll never know.  This is why, despite journal reviewers' comments, null results are not only useful, they are interesting in and of themselves, and as vital as any 'statistically significant' result. We need to know that a treatment doesn't work, that one social group is not terribly different than another, that temperatures in the 'x' range will result in a cascading series of events ultimately leading to the space craft tearing itself apart before it breaks atmosphere.

Things like invterval estimates and prediction error give us a sense of how much work we have left to do. Rely on them heavily.  The goal of research is not to give a definitive answer, but to reduce uncertainty.  If you're not okay with the fuzzy, science is probably not for you.
