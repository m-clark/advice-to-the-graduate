...
And that's what it comes down to primarily, <span class="emph">*desire*</span>, and secondly, <span class="emph">*time*</span>, which you won't necessarily have copious amounts of as a graduate student, who has to manage classes and other aspects of life, or an applied researcher, who may have courses, article writing, and a host of administrative duties to contend with.  Finding the balance will be one of the more difficult challenges you'll have[^powergrad].
